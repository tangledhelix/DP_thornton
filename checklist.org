...
./make_project.py
#+end_src
- [ ] Read the [[https://www.pgdp.net/c/project.php?id=projectID64ae2bc64dae0#project-comments][project comments]]
- [ ] Subscribe to the [[][forum topic]] and read all posts
- [ ] Open ~thornton-utf8.txt~ in Guiguts
