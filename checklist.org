...
"William Thornton and negro colonization" by Hunt, Gaillard

* Things to revisit
- [X] 015: some weird formatting to figure out at the foot of block
- [X] 019: "table header" without a table. How to format? span+padding-left?
- [X] 023: left → center → right closing signature...
- There are sections, not chapters, per PM.
  - [X] New section: 015, 018, 028?
- [X] Drop-cap: 003
- Alignment:
  - [X] Right-align: 013, 018, 028, 032
  - [X] No-indent para: 013, 019(2), 026, 028
- Languages:
  - [ ] Latin: footnote 3(?)
  - [ ] French: 006, 019 (Clavière's title)
  - [ ] French: a few phrases maybe, look for word ~Amis~
- Abbreviations
  - Numerous superscript abbrs to watch for
    - [ ] ~^~ in text
    - [ ] ~<sup>~ in HTML
    - [ ] Unusual roman numeral syntax, 006 (footnote 3)
    - [ ] Some use both superscript abbr form, plus a period (~ag^{st}.~ on 022, ~4^{th}.~ on 026, possibly more)
  - [ ] A couple of things to review in footnote 3.
  - [ ] ~&c~ with no terminating period
  - [ ] ~acct.~ probably ~account~ 025
  - [ ] ~Deg:~ probably ~Degrees~ 018
  - [ ] ~Edin.~ probably ~Edinburgh~ 006 (footnote 3)
  - [ ] ~Hist.~ probably ~History~ 006 (footnote 3)
  - [ ] ~Lat:~ probably ~Latitude~ 018
  - [ ] ~Long:~ probably ~Longitude~ 018
  - [ ] ~MS~ without period 016 (footnote 8)
  - [ ] ~N.~ for ~North~ (N. America) 022
  - [ ] ~Ph. D.~ (class=spell?) 003 (footnote 1)
  - [ ] ~R.I.~ for ~Rhode Island~ 029
* Transcriber Notes
** Leading TN
- Include note about superscript, and that some superscripts are abbreviations.
- smallscaps to ALLCAPS
** Trailing TN
- Footnote 3: changed “therby” to “thereby” (each character thereby mutually fixing)
- p. 18: changed “Propietors” to “Proprietors” (General Court of Proprietors)
- p. 19: changed “verduer” to “verdure” (and with perpetual verdure)
- p. 19: changed “CLAVIÉRE” to “CLAVIÈRE” (WILLIAM THORNTON TO ÉTIENNE CLAVIÈRE)
- p. 19: changed “Claviére” to “Clavière” (Mons.^r [Étienne] Clavière)
- p. 19: changed “must” to “most” (I perused it with most satisfaction)
- p. 24: changed “af” to “of” (engage in the establishment of a Colony)
- p. 25: changed “french” to “French” (as well as the French Settlements)
- p. 27: changed “intelligbly” to “intelligibly” (understanding, or speaking intelligibly)
- p. 27: changed “circultaion” to “circulation” (Papers that obtain extensive circulation)
- p. 29: changed “Member” to “Members” (some of the Members of the Assembly)
- p. 29: changed “then” to “them” (would have furnished them with Ships)
- p. 30: changed “themsevles” to “themselves” (who possessed themselves of these)
- Footnote 6: changed “Lettson” to “Lettsom” (Writings of the late John Coakley Lettsom)
- Footnote 7: changed “Graiu” to “Grain” (near Sierra Leone on the Grain Coast)
* Notes
** General notes
** Proofer notes
** Smooth reader notes
...
** Project comments
#+BEGIN_SRC markdown
Subtitle is **Reprinted from the Proceedings of the American antiquarian society for April,1920.** The original images are from the Library of Congress collection at [TIA](https://archive.org/details/williamthorntonn00hunt/page/n5/mode/2up).

There is nothing out of the ordinary. Formatters, there's not really chapters in this book. Please treat any divisions as sections. If you have any questions, please ask in the project comments.
#+END_SRC
* Checklist
** Process the Pages
...
./make_project.py
#+END_SRC
- [X] Read the [[https://www.pgdp.net/c/project.php?id=projectID64ae2bc64dae0#project-comments][project comments]]
- [X] Subscribe to the forum topic and read all posts
  - Forum topic was never created
- [X] Open ~thornton-utf8.txt~ in Guiguts
...
- Note any illustrations in a list for later handling
...
*** Sidenote fixup
- [X] Use the Sidenote tool to rejoin and reposition sidenotes.
...
*** Move footnotes to landing zones
...
- [X] Use ~File → Save a Copy As~ to make ~thornton.html~
...
- [X] Re-open ~thornton-utf8.txt~ (if not still open).
...
- [X] Open ~thornton.html~ that was saved previously.
...
- [X] Page through the book looking for text that was not handled well by automatic HTML generation, in particular:
  ...
  - [[https://www.pgdp.net/wiki/Indexes][Indexes]] - can use Guiguts ~/i ... i/~ feature
    ...
    - [X] Add ~<nav data-epub-type="index"> .. </nav>~ around the Index (if there is one)
  - Illustrations.
...
- [X] Add ~<nav data-epub-type="toc"> .. </nav>~ around the Table of Contents
...
- [X] Add ~<nav data-epub-type="loi"> .. </nav>~ around the List of Illustrations (if there is one).
- [ ] Semantic fixup
  - Use the Regex Library tool and ~semantic_fixup.json~.
...
- [ ] Go to [[https://www.pgdp.net/c/project.php?id=projectID64ae2bc64dae0][project page]], select SR time period, upload ~thornton-sr.zip~
...
- [ ] Add *anonymized* files to git, e.g. ~thornton-smoothread01.txt~
...
- [ ] Enter copyright clearance (get from DP [[https://www.pgdp.net/c/project.php?id=projectID64ae2bc64dae0][project page]])
...
- [ ] Credits line
  - Paste in from DP [[https://www.pgdp.net/c/project.php?id=projectID64ae2bc64dae0][project page]]
